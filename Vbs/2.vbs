...
Function login 
    ...
    ip = crt.Dialog.Prompt("请输入服务器IP地址:", "CentOS", "192.168.99.197", false) 
    ...
    flag =1 
    While flag = 1 
        username = crt.Dialog.Prompt("请输入登陆用户名:", "CentOS", "root", false) 
        ...
        End If 
    wend 
    passwd = crt.Dialog.Prompt("请输入登陆用户密码:", "CentOS", "root", true) 
    '连接主机 
...
Function writelog    
    ...
    flag =1 
    While flag =1 
        logfilename = crt.Dialog.Prompt("请输入本次会话LOG文件位置", "CentOS", "c:\"  & ip &".log", false) 
